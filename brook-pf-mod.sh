...
#   Description: Brook
#   Version: 1.0
#   Author: Toyo, yulewang(DDNS features), monret(CNAME, iptables), yukino(fix download)
...
Download_brook(){
    ...
    if [[ ${bit} == "x86_64" ]]; then
        ...
        wget --no-check-certificate -N "https://github.com/txthinking/brook/releases/download/v20200801/brook_linux_386"
